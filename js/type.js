$(document).ready(function(){
	...
	var typed = new Typed('#typed',{
		...
		strings: ['Seeing something new @ MNP ', '01000000 00100000 01001101 01001110 01010000' ,'Playing something', 'Getting frustrated while coding','Getting amazed while coding' ,'Talking to some friends', 'Learning something new', 
		...
		'Writting hello world in a new language :)', 'getting richer'],
		typeSpeed: 50,
		backSpeed: 30, 
		loop: true, 
		showCursor: true,

$(document).ready(function(){
	...
	var typed = new Typed('#typed',{
		...
		strings: ['Seeing something new @ MNP ', 'Playing something', 'Getting frustrated while coding','Getting amazed while coding' ,'Talking to some friends', 'Learning something new', 
